...
def set_screen_size():
    ...
    msg2=f"La Altura de Pantalla Predeterminada para este monitor = {default_hgt}.\n"
    msg3='La Altura Máxima para este monitor es  ' + str(height) +' (Pantalla Completa).\n'
