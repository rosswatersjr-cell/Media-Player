        ...
        if proc.stderr=="":
            ...
            if proc.stderr=="":
                ...
                if pgm_path == "":# Restart And Check Again
                    ...
                    return True
            else:raise Exception("¡Sin Detalles!")    
        else:raise Exception("¡Error de Instalación!")
    except Exception as e:
