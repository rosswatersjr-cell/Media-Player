...
class App(ctk.CTk):#CustomTkinter window controlled by asyncio instead of mainloop().
    def __init__(self):
      ...
      # Define All Supported File Extensions
        ...
        self.time_scale = Scale(self.main_frame, variable=self.Time_Now, relief="sunken",orient='horizontal',resolution=0.001,from_=0.0, to=100.0,
                            bg=slider_fg,borderwidth=0, font=self.slider_font, troughcolor=slider_tc, showvalue=0,  
    ...
    def set_screen_position(self):
        ...
        msg = "Select The Desired Video Screen Position."
            ...
            while not self._stop_timer:
                ...
                if self.paused:# self._factor Is Correction For Paused Time For Slider
                    ...
                    if remaining < 0.0:
                        ...
                        remaining = 0.0
                    self.Time_Now_Txt.set(f"Time:(Total;{round(self.duration, 1)} sec., Elapsed;{round(self._time_now, 1)} sec., Remaining; {round(remaining, 1)} sec.)")
    ...
    def set_image_size(self):
        ...
        msg = "Select The Desired Size For Image Displayed."
