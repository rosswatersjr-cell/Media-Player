...
class App(ctk.CTk):#CustomTkinter window controlled by asyncio instead of mainloop().
    ...
    def set_screen_position(self):
        ...
        msg2 = 'Reproducir el Video, luego haz clic en Vale.\n'
    ...
    def set_color_theme(self, theme):
        ...
        msg = "Selecciona el Tema de Color que Quieras, Luego haz Clic en Vale."
    ...
    def on_slide(self, value):
        try:
            if self.duration > 0.0:
                ...
                self.Time_Now_Txt.set(f"Tiempo Total:{round(self.duration, 1)} seg., Transcurrido: {float(value)} seg., Restante: {round(remaining, 1)} seg.")
        except Exception as e:
            pass
    def about(self):
    ...
    def set_image_size(self):
        ...
        msg1 = "Selecciona el Tamaño de Imagen que Quieras,\n"
        msg2 = "luego haz Clic en Vale."
        msg=msg1+msg2
